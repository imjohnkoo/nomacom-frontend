...
| 제약                                                                                                  | 프로세스 대응                                                                                               |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| **admin/client 테스트는 얇다** (INF-1 로 러너는 붙었다 — client 872건(2026-09-23 W1-3 오류 화면 반영), admin 0건) | 회귀 테스트를 **우선 시도**하고, 대상이 순수 로직이 아니면 검증 증거(커맨드 출력·Orca 스크린샷)로 대체 + plan 에 사유 명시 |
